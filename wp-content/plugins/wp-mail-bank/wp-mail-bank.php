...
if (!defined("mail_bank_version_number")) {
   define("mail_bank_version_number", "3.0.12");
}
...
function wmb_fs() {
   ...
   if (!isset($wmb_fs)) {
      ...
      $wmb_fs = fs_dynamic_init(array(
          'id' => '1320',
          'slug' => 'wp-mail-bank',
          'type' => 'plugin',
          'public_key' => 'pk_422b3c2cbc3d0b9af76dd7209611a',
          'is_premium' => false,
          'has_addons' => false,
          'has_paid_plans' => false,
          'menu' => array(
              'first-path' => 'admin.php?page=mb_email_configuration',
              'account' => false,
              'contact' => false,
              'support' => false,
          ),
            ...
            if (!$this->mb_required_fields($admin_notices[$slug])) {
               ...
               if ($admin_display_check == 0 && strtotime($admin_display_start) <= strtotime($current_date)) {
                  ...
                  if (strpos($slug, 'promo') === FALSE) {
                     ...
                     echo '<div class="update-nag mb-admin-notice" style="width:96%!important;">
                               <div></div>
