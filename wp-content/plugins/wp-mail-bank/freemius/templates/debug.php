         ...
         <td>
            ...
            <form action="" method="POST">
               ...
               <button class="button button-primary"
                       onclick="if (confirm('<?php fs_echo('delete-all-confirm') ?>'))
                                this.parentNode.submit();
                             return false;"><?php fs_echo('delete-all-accounts') ?></button>
            </form>
         </td>
         <td>
            <!-- Clear API Cache -->
      ...
      <tbody>
         <?php foreach ($plugins as $slug => $data) : ?>
            ...
            ?>>
               ...
               <td<?php
               if ($is_active && !$fs->has_api_connectivity()) {
         ...
         <tbody>
            <tr style="display: none">
               ...
               <td class="fs-col--message">
                  <a href="#" onclick="jQuery(this).parent().find('div').toggle();
                           return false;">
