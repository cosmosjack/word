...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      if ($flag == "1") {
         ...
         add_submenu_page("mb_email_configuration", $mb_connectivity_test, $mb_connectivity_test, "read", "mb_connectivity_test", "mb_connectivity_test");
         ...
         add_submenu_page("mb_email_configuration", $mb_upgrade, $mb_upgrade, "read", "mb_upgrade", "mb_upgrade");
      }
